...
// // const store_id = process.env.SSL_STORE_ID || 'test';
// // const store_passwd = process.env.SSL_STORE_PASSWORD || 'test';
...
// // // অন্যান্য ফাংশন গুলো আগের মতোই থাকবে...
// // const paymentSuccess = async (req, res) => {
// //     try {
// //         console.log('Payment Success Data:', req.body);
// //         const { tran_id, val_id } = req.body;
        
// //         res.redirect(`http://localhost:5173/payment-success?orderId=${tran_id}`);
...
// //     res.redirect(`http://localhost:5173/payment-fail?orderId=${tran_id}`);
// // };

// // const paymentCancel = async (req, res) => {
// //     console.log('Payment Cancel Data:', req.body);
// //     const { tran_id } = req.body;
// //     res.redirect(`http://localhost:5173/payment-cancel?orderId=${tran_id}`);
// // };
...
// // মক পেমেন্ট ইনিশিয়েট করার ফাংশন
// const initiatePayment = async (req, res) => {
//     try {
//         const { orderId, total, customer, productName } = req.body;
        
//         // এখানে শুধু একটি সেশন আইডি তৈরি করে ফ্রন্টএন্ডে পেমেন্ট পেজের URL পাঠিয়ে দিন
//         const paymentSessionId = `MOCK_SESSION_${orderId}`;
        
//         // মক পেমেন্ট পেজে রিডাইরেক্ট করুন
//         res.json({
//             success: true,
//             redirectUrl: `http://localhost:5174/payment-mock?orderId=${orderId}&total=${total}&sessionId=${paymentSessionId}`,
//             message: 'Redirecting to mock payment page'
//         });
...
// // মক পেমেন্ট ভারিফিকেশন (OTP চেক করবে)
// const verifyMockPayment = async (req, res) => {
//     try {
//         const { orderId, phoneNumber, otp } = req.body;
        
//         // মক OTP চেক করুন (সাধারণত ডাটাবেসে সেভ করা থাকে)
//         // টেস্টিং এর জন্য যেকোনো ৬ ডিজিটের নাম্বার OTP হিসেবে কাজ করবে
//         if (otp === '123456') {
//             // পেমেন্ট সফল
//             res.json({
//                 success: true,
...
// // ... অন্যান্য ফাংশন (paymentSuccess, paymentFail, paymentCancel, handleIPN)
