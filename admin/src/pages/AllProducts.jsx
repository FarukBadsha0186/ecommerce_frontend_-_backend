  ...
  const fetchProducts = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        // API response স্ট্রাকচার অনুযায়ী ডাটা এক্সট্র্যাক্ট
...
const handleEdit = (productId) => {
  ...
  console.log("Token exists, navigating to:", `/edit-product/${productId}`);
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
              ...
              <input
                ...
                onKeyPress={(e) => e.key === 'Enter' && setPageNo(1)}
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <div className="text-xs text-gray-400 mb-2">
                      <p>Category: {product.category_id?.category_name || product.category_name || 'N/A'}</p>
                      <p>Brand: {product.brand_id?.brand_name || product.brand_name || 'N/A'}</p>
                    </div>
                        ...
                        <div className="flex flex-wrap gap-1">
                          ...
                          {product.color.slice(0, 3).map((color, idx) => (
                            <span key={idx} className="text-xs text-white">
                              {color}{idx < Math.min(product.color.length, 3) - 1 ? ',' : ''}
                            </span>
                          ))}
                      ...
                      {product.size && product.size.length > 0 && (
                        <div className="flex flex-wrap gap-1">
                          ...
                          {product.size.slice(0, 3).map((size, idx) => (
                            <span key={idx} className="text-xs text-white">
                              {size}{idx < Math.min(product.size.length, 3) - 1 ? ',' : ''}
                            </span>
                          ))}
                    ...
                    <div className="flex gap-2 mt-4">
                      <button
                        ...
                        className="flex-1 bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded-lg transition font-medium text-sm"
                      >
                        ✏️ Edit
                      </button>
                      <button
                        ...
                        className="flex-1 bg-red-600 hover:bg-red-700 px-4 py-2 rounded-lg transition font-medium text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                      >
